...
import './ReferencesMobile.css';

export default () => {
  return (
    <div className="componentReferencesMobile ReferencesMobile-component">
      <div className="contentMyReferencesMobile">
        <h1>My References</h1>
        <br />

      <div class="referenceInfoMobile">
        <div><h2>Reference 1: </h2></div>
